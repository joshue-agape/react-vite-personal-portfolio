...
export const projects: Project[] = [
    ...
    },
    {
        ...
        category: 'Web Application',
        demo: 'https://joshue-agape-personal-portfolio.vercel.app/',
        github: 'https://github.com/joshue-agape/react-vite-personal-portfolio',
        stars: 142,
        featured: true,
        metrics: [],
        color: 'accent',
...
export const toolbox: ToolBox[] = [
    ...
    },
    {
        ...
        description:
            'Predefined aliases for Express projects to speed up project creation and setup.',
        color: 'green',
        type: 'Alias PowerShell Windows',
    },
    {
        ...
        description:
            'Predefined aliases for FastAPI projects to speed up project creation and setup.',
        color: 'orange',
        type: 'Alias PowerShell Windows',
    },
    {
        ...
        title: 'VueJS Project',
        description:
            'Predefined aliases for VueJS projects to speed up project creation and setup.',
        color: 'purple',
        type: 'Alias PowerShell Windows',
    },
    {
        ...
        description:
            'Predefined aliases for ReactJS projects to speed up project creation and setup.',
        color: 'accent',
        type: 'Alias PowerShell Windows',
    },
];
